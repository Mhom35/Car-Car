        ...
        <div className="row">
            <div className="offset-3 col-6">
                <div className="shadow p-3 mb-5 bg-body rounded">
                    <div className="alert alert-danger d-flex align-items-center d-flex p-2 d-none"  id="alert" style={{height:"50px"}} role="alert">
                    ...
                    <div>
                        Employee already exists please choose another
                    </div>
                    </div>
